...
public class AlipayTemplate {
    ...
    public Boolean checkSignature(PayAsyncVo payAsyncVo){
        try {
            Map<String, String> paramsMap = JSON.parseObject(JSON.toJSONString(payAsyncVo), HashMap.class);
            return AlipaySignature.rsaCheckV1(paramsMap, alipay_public_key, "utf-8", "RSA2");  //调用SDK验证签名
